...
extension WebRequest {
    ...
    static func requestDanmuWebView(cid: Int) async throws -> DmWebViewReply {
        try await requestPB(url: "https://api.bilibili.com/x/v2/dm/web/view", parameters: ["type": 1, "oid": cid])
    }
    
    static func requestDanmuList(cid: Int, segmentIdx: Int) async throws -> DmSegMobileReply {
        try await requestPB(url: "https://api.bilibili.com/x/v2/dm/list/seg.so", parameters: ["type": 1, "oid": cid, "segment_index": segmentIdx])
    }
}
